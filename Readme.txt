...
multiFeature_submit.py contains the code to generate multi-feature embedding using Doc2Vec. It also includes the code for SVM and Logistic Regression Classifiers. By default, it will train the model on Game1 and test it on Game2.
